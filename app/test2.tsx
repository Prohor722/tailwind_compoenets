          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:scale-105 transition-all duration-300">
              <div className="flex justify-between items-start mb-4">
                ...
                >
                  <Heart className={`w-5 h-5 transition-colors ${likedCards.has('glass') ? 'text-red-400 fill-red-400' : 'text-white/70'}`} />
                </button>
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Glassmorphism Design</h3>
              <p className="text-white/70 mb-4">Beautiful frosted glass effect with vibrant gradients and smooth interactions.</p>
