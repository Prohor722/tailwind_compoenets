  ...
  return (
    <div className="min-h-screen bg-gray-50 space-y-12 p-4">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-gray-800">1. Glassmorphism Navbar</h2>
          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <a href="#" className="text-gray-700 hover:text-purple-600 transition-colors font-medium">Products</a>
            ...
            {mobileMenu1 && (
              <div className="md:hidden mt-4 space-y-3 pb-4">
                <a href="#" className="block text-gray-700 hover:text-purple-600 transition-colors">Home</a>
                <a href="#" className="block text-gray-700 hover:text-purple-600 transition-colors">Products</a>
                <a href="#" className="block text-gray-700 hover:text-purple-600 transition-colors">About</a>
                <a href="#" className="block text-gray-700 hover:text-purple-600 transition-colors">Contact</a>
