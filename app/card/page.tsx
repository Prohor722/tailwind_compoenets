...
const Card = () => {
  return (
    <div className="min-h-screen bg-gray-100 p-8 flex flex-col items-center gap-10">
      <h1 className="text-2xl font-bold text-gray-800">Tailwind Card Showcase</h1>

      <div className="flex flex-wrap justify-center gap-8 max-w-6xl">
        {/* Basic Shadow Card */}
        <div className="bg-white shadow-md rounded-lg p-6 w-64">
          <h2 className="text-lg font-semibold mb-2">Basic Card</h2>
          <p className="text-gray-600">This is a simple card with a shadow, padding, and border radius.</p>
        </div>
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden w-64">
          ...
          <div className="p-4">
            ...
            <p className="text-gray-600 text-sm">Beautiful landscape from Unsplash.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-300 rounded-lg p-6 w-64">
          ...
          <p className="text-gray-600">This card uses a subtle border instead of shadow.</p>
        </div>
        ...
        <div className="bg-blue-600 text-white rounded-lg p-6 w-64 shadow-lg">
          ...
          <p className="text-sm">Great for callouts, tips, or promotional blocks.</p>
        </div>
      </div>
    </div>
  )
