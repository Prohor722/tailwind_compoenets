            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-slate-100 to-blue-50 border-b border-slate-200">
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold text-slate-700">Deal Value</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-slate-700">Stage</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-slate-700">Probability</th>
                  ...
                  <tr key={item.id} className="border-b border-slate-100 hover:bg-blue-50 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <div className="relative inline-block">
                        <div className={`absolute inset-0 bg-gradient-to-r ${getStageColor(item.stage)} rounded-lg blur opacity-30`}></div>
                        <span className={`relative inline-flex px-3 py-1 bg-gradient-to-r ${getStageColor(item.stage)} text-white text-xs font-bold rounded-lg`}>
                          {item.stage}
                        </span>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <span className={`inline-flex px-3 py-1 rounded-full text-xs font-bold ${getProbabilityColor(item.probability)}`}>
                        {item.probability}%
                      </span>
                    </td>
