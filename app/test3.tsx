        ...
        <nav className="max-w-6xl mx-auto bg-white rounded-full shadow-xl px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-gray-900 hidden sm:block">Minimal</span>
            </div>
            
            <div className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm font-medium">Work</a>
              <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm font-medium">Studio</a>
              <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm font-medium">Journal</a>
              <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm font-medium">Contact</a>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <button onClick={() => setMobileMenu1(!mobileMenu1)} className="md:hidden">
                {mobileMenu1 ? <X className="w-5 h-5" /> : <Menu className="w-5 h-5" />}
              </button>
            </div>
          </div>
          ...
          {mobileMenu1 && (
            <div className="md:hidden mt-4 pt-4 border-t border-gray-100 space-y-3">
              <a href="#" className="block text-gray-600 hover:text-gray-900">Work</a>
              <a href="#" className="block text-gray-600 hover:text-gray-900">Studio</a>
              <a href="#" className="block text-gray-600 hover:text-gray-900">Journal</a>
