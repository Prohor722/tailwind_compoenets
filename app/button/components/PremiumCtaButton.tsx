...
const PremiumCtaButton = () => {
  return (
    <button className="cursor-pointer relative px-8 py-4 bg-gradient-to-r from-yellow-400 via-yellow-500 to-orange-500 text-white font-bold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 overflow-hidden">
