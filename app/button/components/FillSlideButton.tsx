const FillSlideButton = () => {
    return (
        <button className="group cursor-pointer relative px-6 py-3 overflow-hidden border border-lime-400 text-lime-400 rounded-md hover:text-black transition duration-300">
