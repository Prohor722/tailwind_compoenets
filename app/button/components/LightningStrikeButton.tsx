...
const LightningStrikeButton = () => {
  ...
  return (
    <button
      ...
      className="cursor-pointer h-12 w-60 relative text-center bg-yellow-500 text-black font-bold rounded-lg overflow-hidden group hover:bg-yellow-400 transition-colors duration-200"
    >
