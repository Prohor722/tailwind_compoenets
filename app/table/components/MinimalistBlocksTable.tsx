  ...
  return (
    <div className="max-w-md grid grid-cols-2 md:grid-cols-3 gap-3">
      {tableData.map((row, idx) => (
        ...
        >
          <div className="inset-0 from-blue-500/0 to-purple-500/0 group-hover:from-blue-500/5 group-hover:to-purple-500/5 rounded-xl transition-all duration-300"></div>
