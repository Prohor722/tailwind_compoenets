                  ...
                  <tr key={item.id} className="border-b border-slate-100 hover:bg-blue-50 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2 bg-slate-100 rounded-lg w-fit mx-auto">
                        <button onClick={() => updateQty(item.id, -1)} className="p-1 hover:bg-slate-200 transition-colors rounded">
                          <Minus className="w-4 h-4 text-slate-600" />
                        </button>
                        <span className="w-8 text-center font-semibold text-slate-900">{quantities[item.id] || 1}</span>
                        <button onClick={() => updateQty(item.id, 1)} className="p-1 hover:bg-slate-200 transition-colors rounded">
                    ...
                    <td className="px-6 py-4 text-right text-sm font-bold text-slate-900">
                      ${parseInt(item.price.replace('$', '').replace(',', '')) * (quantities[item.id] || 1)}
                    </td>
                  </tr>
                ))}
              </tbody>
