    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-900 to-slate-950 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          ...
          {data.map((item) => (
            <div key={item.id} className="bg-gradient-to-r from-slate-800 to-slate-800 rounded-xl border border-slate-700 hover:border-purple-500/50 transition-all hover:shadow-lg hover:shadow-purple-500/20 p-6 group cursor-pointer">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-400">{item.role} • Active today</p>
                  </div>
                </div>
              ...
              <div className="bg-slate-900/50 rounded-lg p-4 mb-4 border border-slate-700/50">
                <div className="space-y-2">
                  <p className="text-slate-300 text-sm">Revenue: <span className="text-blue-300 font-semibold">{item.revenue}</span></p>
                  <p className="text-slate-300 text-sm">Engagement: <span className="text-purple-300 font-semibold">{item.engagement}%</span></p>
                </div>
              </div>

              <div className="flex items-center justify-between text-slate-400 text-sm">
                <div className="flex items-center gap-4">
                  <button onClick={() => toggleLike(item.id)} className="flex items-center gap-2 hover:text-red-400 transition-colors group/like">
                    <Heart className={`w-4 h-4 transition-all ${likedItems.has(item.id) ? 'fill-red-400 text-red-400' : ''}`} />
