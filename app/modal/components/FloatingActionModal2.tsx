  ...
  return (
    <div>
      <div className={`fixed bottom-6 right-6 z-50
        ...
        <div className="bg-white rounded-2xl shadow-2xl border p-4 w-64 transform origin-bottom-right animate-scale-up">
          ...
          <div className="space-y-2">
            <button className="cursor-pointer w-full flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 transition-colors text-left">
      ...
      <button
        ...
        className="cursor-pointer flex justify-center items-center gap-2 bg-white hover:bg-gray-50 shadow-lg hover:shadow-xl border border-gray-200 rounded-2xl p-2 text-left transition-all duration-200 hover:scale-105"
      >
