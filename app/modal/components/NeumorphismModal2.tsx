    ...
    <div>
      ...
      <div className="text-center">
        <button
          ...
          className="flex jusity-center items-center gap-2 bg-gray-200 text-gray-700 px-8 py-3 rounded-full font-semibold shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff] hover:shadow-[inset_5px_5px_10px_#bebebe,inset_-5px_-5px_10px_#ffffff] transition-all"
        >
