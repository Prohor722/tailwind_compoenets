          ...
          <div className="relative max-w-7xl mx-auto px-6 py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="relative group">
                  <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-110" style={{transform: 'translateZ(20px)'}}>
                    <Flame className="w-7 h-7 text-white animate-pulse" />
                  </div>
                  <div className="absolute inset-0 bg-white/30 rounded-2xl blur-xl"></div>
                </div>
                <span className="text-2xl font-black text-white" style={{textShadow: '2px 2px 8px rgba(0,0,0,0.3)'}}>
                  DEPTH
                </span>
              </div>
              ...
              <div className="hidden lg:flex items-center space-x-3">
                {['Home', 'Work', 'Services', 'Blog', 'Contact'].map((item, idx) => (
                  <a
                    key={idx}
                    href="#"
            ...
            {mobileMenu1 && (
              <div className="lg:hidden mt-6 space-y-2 pb-4 border-t border-white/20 pt-4">
                {['Home', 'Work', 'Services', 'Blog', 'Contact'].map((item, idx) => (
                  <a key={idx} href="#" className="block text-white/90 hover:text-white py-3 px-4 rounded-xl hover:bg-white/20 transition-all">
                    {item}
                  </a>
                ))}
