...
const Navbar = () => {
  return (
    <div><div className="min-h-screen bg-gray-100 p-6 flex flex-col items-center gap-10">
    ...
    <nav className="w-full max-w-4xl bg-blue-50 px-6 py-4 rounded flex flex-col md:flex-row md:items-center md:justify-between shadow">
      <div className="text-2xl font-semibold text-blue-700 text-center md:text-left">BrandName</div>
    ...
    <nav className="w-full max-w-4xl bg-gray-900 text-white px-6 py-4 rounded flex justify-between items-center shadow">
      ...
      <ul className="flex gap-6 items-center">
        <li><a href="#" className="flex items-center gap-1 hover:text-gray-300"><Home size={18} />Home</a></li>
        <li><a href="#" className="flex items-center gap-1 hover:text-gray-300"><User size={18} />Profile</a></li>
