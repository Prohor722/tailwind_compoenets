  ...
  return (
    <nav className="relative bg-black/60 backdrop-blur-xl rounded-3xl overflow-hidden border border-emerald-500/30">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute -top-1/2 left-0 w-full h-full bg-gradient-to-r from-emerald-500/20 via-cyan-500/20 to-blue-500/20 blur-3xl animate-pulse"
          style={{ animationDuration: "4s" }}
        ></div>
        <div
          className="absolute top-0 -left-1/4 w-full h-full bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-emerald-500/20 blur-3xl animate-pulse"
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-5">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="lg:hidden text-emerald-400 p-2"
          >
            {mobileMenu2 ? (
              <X className="w-6 h-6" />
            ) : (
          ...
          <div className="lg:hidden mt-6 space-y-2 pb-4 border-t border-emerald-500/30 pt-4">
            {[
              ...
              <a
                key={idx}
                href="#"
                className="flex items-center space-x-3 text-emerald-300/70 hover:text-emerald-300 py-2 px-4 rounded-xl hover:bg-emerald-500/10 transition-all"
              >
